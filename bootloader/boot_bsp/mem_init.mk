...
# Memory: constants
MEM_0 := oduk_muxponder_dual_constants
$(MEM_0)_NAME := constants
...
$(MEM_0)_END := 0x0000201f
$(MEM_0)_SPAN := 0x00000020
$(MEM_0)_HIERARCHICAL_PATH := constants
$(MEM_0)_WIDTH := 32
...
.PHONY: constants
constants: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: flash_tristate_controller_0
MEM_1 := flash_tristate_controller_0
$(MEM_1)_NAME := flash_tristate_controller_0
...
$(MEM_1)_START := 0x03000000
$(MEM_1)_END := 0x03ffffff
$(MEM_1)_SPAN := 0x01000000
$(MEM_1)_HIERARCHICAL_PATH := flash_tristate_controller_0
$(MEM_1)_WIDTH := 8
$(MEM_1)_HEX_DATA_WIDTH := 8
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: flash_tristate_controller_0
flash_tristate_controller_0: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: onchip_memory2_0
MEM_2 := oduk_muxponder_dual
...
$(MEM_2)_START := 0x00400000
$(MEM_2)_END := 0x004fffff
$(MEM_2)_SPAN := 0x00100000
...
$(MEM_3)_START := 0x02000000
$(MEM_3)_END := 0x02ffffff
$(MEM_3)_SPAN := 0x01000000
