...
/*!<s_task's signature:*/
typedef void (*s_task_t)(s_task_handle_t, s_task_msg_t **);   
...
bool s_task_create(bool active, s_task_priority_t s_task_prio,
		           cntr_size_t s_ticks,s_task_t s_task_ptr, s_task_handle_t *);
...
bool s_task_set_periodic_ticks(s_task_handle_t s_task_hndl,
							   cntr_size_t s_ticks, bool run);
